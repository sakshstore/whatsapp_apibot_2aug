<?php $__env->startSection('template_title'); ?>
    <?php echo e(__('Create')); ?> Mass Message
    ...
    <section class="content container ">
        <div class="row">
            <div class="col-md-12">
                        ...
                        <span class="card-title"><?php echo e(__('Create')); ?> Mass Message</span>
                    
                 
                        <form method="POST" action="<?php echo e(route('mass-messages.store')); ?>"  role="form" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
...
<div class="modal fade" id="contentModel" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <div class="accordion-item">
    <h2 class="accordion-header">
      <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse<?php echo e($template->id); ?>" aria-expanded="false" aria-controls="collapse<?php echo e($template->id); ?>">
        <?php echo e($template->name); ?>

      </button>
    </h2>
    <div id="collapse<?php echo e($template->id); ?>" class="accordion-collapse collapse" data-bs-parent="#accordion">
      <div class="accordion-body">
       
       <?php echo e($template->message); ?>

   
       <button type="button"    onclick="saksh_return_content('<?php echo e($template->message); ?>')"   class="btn btn-secondary closebtn" data-bs-dismiss="modal">Use this</button>
...
function update_chat_request_status(ai_query )
{
   ...
   $.ajax(
   {
      url: "<?php echo e(route('generate_ai_content')); ?>?ai_query=" + ai_query ,
      type: "post",
      dataType: 'json',
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vikkinbot/laraauth9/resources/views/mass-message/create.blade.php ENDPATH**/ ?>