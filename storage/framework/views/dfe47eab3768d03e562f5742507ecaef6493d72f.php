 ...
 if ($("#postForm").length > 0) {
    ...
    $('#meta_apps').empty(); 
      ...
      $.ajax({
          ...
          url: "<?php echo e(route('create_meta_app')); ?>",
          type: "post",
          dataType: 'json',
...
function reload_meta_app( from_number )
{
    ...
    $.ajaxSetup({
      ...
      $.ajax({
          data: $('#postForm').serialize(),
          url: "<?php echo e(route('meta_apps_list' )); ?>",
          type: "GET",
          dataType: 'json',
          success: function (meta_apps_list) {
  ...
  function enable_disable_app(id,status)
 {
  ...
  var formData = {
      ...
      $.ajax({
            ...
            data: formData ,
          url: "<?php echo e(route('enable_disable_app')); ?>",
          type: "post",
          dataType: 'json',
 ...
 { 
  ...
  var formData = {
      ...
      $.ajax({
            ...
            data: formData ,
          url: "<?php echo e(route('delete_meta_app')); ?>",
          type: "post",
          dataType: 'json',
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vikkinbot/laraauth9/resources/views/manage_app.blade.php ENDPATH**/ ?>