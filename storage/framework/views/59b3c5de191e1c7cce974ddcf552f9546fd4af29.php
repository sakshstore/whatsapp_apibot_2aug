        ...
        <div class="row">
            <div class="col-md-12">
                   ...
                   <?php echo e(__('Create')); ?> Template 
                        ...
                        <form method="POST" action="<?php echo e(route('templates.store')); ?>"  role="form" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vikkinbot/laraauth9/resources/views/template/create.blade.php ENDPATH**/ ?>